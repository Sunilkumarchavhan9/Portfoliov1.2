...
export const Nodejs: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => {
  return (
    <svg
      ...
      {...props}
    >
      <mask id="mask0_872_3158" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x="1" y="0" width="14" height="16">
      ...
      <mask id="mask1_872_3158" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x="1" y="0" width="14" height="16">
      ...
      <mask id="mask2_872_3158" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x="1" y="0" width="14" height="16">
